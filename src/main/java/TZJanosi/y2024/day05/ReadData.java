...
public class ReadData {
        ...
        try(BufferedReader reader = new BufferedReader(new InputStreamReader(TZJanosi.y2024.day05.ReadData.class.getResourceAsStream(name)))){
    ...
    public List<List<Integer>> readPpageOrders(String name){
        String line;
        String[] arrayFromLine;
