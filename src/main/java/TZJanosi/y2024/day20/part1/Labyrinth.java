...
public class Labyrinth {
    ...
    //    private int bestFound=Integer.MAX_VALUE;
    private int bestFound = 157564;
    private int globalLimit = Integer.MAX_VALUE;
    private Map<Node, Integer> memory = new HashMap<>();
    private int order = 0;
    List<Coordinate> wayOut;
    ...
    public List<Coordinate> getWayOut() {
        wayOut = getWayFromInProgressToCoordinate(end);
        return wayOut;
    }
