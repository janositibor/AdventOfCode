...
public class DirectionalPad {
    private static Map<DirectionButtonPairs, Set<String>> memory = new ConcurrentHashMap<>();
    ...
    public DirectionalPad next(String input) {
        ...
        if (memory.containsKey(directionButtonPairsForMemory)) {
            ...
            validWaysWithClosingA = extendValidWaysWithClosingA(validWays);
    ...
    private Set<String> extendValidWaysWithClosingA(Set<String> input) {
