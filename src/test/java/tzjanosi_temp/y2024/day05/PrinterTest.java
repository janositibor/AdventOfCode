...
class PrinterTest {
    ...
    void testCreatePrinter(){
        ...
        Printer printer = new Printer(readData.readRestriction("testRestrictions.txt"), readData.readPageOrders("testPageOrders.txt"));
...
//        System.out.println(printer.getSumOfCentralElements());
    ...
    void findWithProblemDataTest(){
        ReadData readData=new ReadData();
        Printer printer = new Printer(readData.readRestriction("restrictions.txt"), readData.readPageOrders("pageOrders.txt"));
